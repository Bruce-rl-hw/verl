...
# =============================================================================
# Compatibility functions for verl (file-based legacy approach)
# =============================================================================


def load_routing_from_file(*args, **kwargs):
    """Legacy compatibility function - not used in SharedMemory approach."""
    import warnings
    warnings.warn(
        "load_routing_from_file is deprecated. "
        "Router Replay now uses SharedMemory via RoutedExpertsCapturer/Reader.",
        DeprecationWarning,
        stacklevel=2
    )
    return None
...
def enable_capture():
    """Legacy compatibility - capturer is now controlled via enable_return_routed_experts."""
    pass
...
def is_capture_enabled():
    """Legacy compatibility - check via model_config.enable_return_routed_experts instead."""
    return False
